...
export function classifyBoard(cards) {
  ...
  const span = vals[0] - vals[2]; // gap between highest and lowest
  ...
  const connected = span <= 4; // cards within a 4-rank span = very connected
...
// Full postflop training scenarios
...
// SPR scenarios for postflop quiz
